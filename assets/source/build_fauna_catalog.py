...
SPECIES = (
    ...
    {
        "id": "cinder_plate_rhino",
        "display_name": "Cinder-Plate Rhino",
        "model": "cinder_plate_rhino",
        # Crawler siege owns the live chargers. The species stays filed so the
        # paint and clips stay wired, without seeding a story-mode herd.
        "enabled": False,
        "disposition": 2,  # HOSTILE
        "move_set": 7,
        "locomotion": 0,
        "attack_style": 1,  # CONTACT; crawler_rhino runs the horn charge
        "paint_style": (
            "Pebbled slate-violet hide, grey-blue plate strata over the back "
            "and flanks, a banded amber horn, near-black hooves, a dusty rose "
            "belly, and mip-safe molten ember seams"
        ),
        "height": 1.85,
        "height_variation": 0.08,
        "variant_tint_a": (1.0, 0.92, 0.88, 1.0),
        "variant_tint_b": (0.88, 0.93, 1.0, 1.0),
        "saturation": 1.30,
        "brightness": 1.04,
        "biome_tint_strength": 0.16,
        "night_emission_color": (1.0, 0.48, 0.18, 1.0),
        "night_emission_energy": 2.30,
        "night_emission_albedo": 0.44,
        "night_pulse_amount": 0.18,
        "night_pulse_speed": 0.19,
        "local_light_color": (1.0, 0.52, 0.20, 1.0),
        "local_light_energy": 1.70,
        "local_light_range": 9.5,
        "local_light_height_share": 0.55,
        "collision_radius_share": 0.40,
        "collision_height_share": 0.74,
        "combat_radius_share": 0.50,
        "ground_layer": 0,
        "minimum_ground_claim": 0.0,
        "above_water": 5.0,
        "below": 420.0,
        ...
        "maximum_instances": 6,
        "spawn_within": 240.0,
        "despawn_beyond": 310.0,
        "random_seed": 20268134,
        "colony_count": 0,
        "health": 190.0,
        "health_per_metre": 30.0,
        "toughness": 1,
        "respawn_delay": 24.0,
        "walk_speed": 1.9,
        "run_speed": 6.4,
        ...
        "macro_scale": 1.05,
        "macro_amount": 0.14,
        "camera_rim_color": (1.0, 0.58, 0.26, 1.0),
